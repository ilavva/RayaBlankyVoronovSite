...
function setFooterData() {
	...
	<a href="mailto:raya.bv@gmail.com" target="_blank" alt="email"><div class="media-icon-container"><span class="media-icon smaller"> <i class="fa fa-envelope-o" aria-hidden="true"></i></span></div></a>
